  ...
  tables: [
    {
      ...
      rows: [
        { name: "Base44", country: "Pending confirmation", service: "Application hosting, database, authentication and platform-delivered transactional email", transfer: "Pending legal review — hosting region not published by CAMBRA", status: "CONFIRMED — provider; region and transfer instrument pending" },
