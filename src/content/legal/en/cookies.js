...
export default {
  ...
  tables: [
    ...
    },
    {
      ...
      rows: [
        ...
        { name: "cambra_cookie_consent", purpose: "Records your cookie-consent choice and its timestamp", duration: "Until browser data cleared", category: "Strictly necessary" },
  ...
  after: [
    ...
    {
      title: "8. Contact",
      body: "Questions about how CAMBRA uses cookies and browser storage: privacy@cambra.global. Publisher: CAMBRA GLOBAL SASU, SIREN 105 452 916, 42 rue Vivienne, 75002 Paris, France.",
    },
  ],
};