  ...
  tables: [
    {
      ...
      rows: [
        { name: "Base44 (Wix.com Ltd.)", country: "Israël (siège de Wix.com Ltd., opérateur de Base44) — région d'hébergement des données non publiée par le prestataire", service: "Hébergement de l'application, base de données, authentification et envoi d'e-mails transactionnels par la plateforme", transfer: "Le propre DPA de Base44 déclare le EU-US Data Privacy Framework et les clauses contractuelles types de l'UE (Module 2/3) comme mécanisme pour les transferts depuis l'EEE/Suisse/Royaume-Uni. Le prestataire ne publie pas la région d'hébergement ni l'infrastructure cloud sous-jacente — confirmation directe auprès de Base44/Wix en attente", status: "CONFIRMÉ — instrument de transfert déclaré par le prestataire ; région d'hébergement en attente de confirmation directe" },
