  ...
  tables: [
    {
      ...
      rows: [
        { name: "Base44", country: "Pendiente de confirmación", service: "Alojamiento de la aplicación, base de datos, autenticación y envío de correo transaccional desde la plataforma", transfer: "Pendiente de revisión jurídica — CAMBRA no publica la región de alojamiento", status: "CONFIRMADO — proveedor; región e instrumento de transferencia pendientes" },
