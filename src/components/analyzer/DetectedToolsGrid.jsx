...
export default function DetectedToolsGrid({ tools, confirmed, dismissed, onToggle }) {
  // Group tools by bucket
  const groups = {};
  for (const t of tools) {
    const bucket = categoryFor(t.category);
    ...
    return (
      <div className="rounded-2xl border border-border/60 bg-secondary/30 p-6 text-center">
        <p className="text-sm font-semibold text-foreground mb-1">
          We couldn't detect your stack automatically.
        </p>
