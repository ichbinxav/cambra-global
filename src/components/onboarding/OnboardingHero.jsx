      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-6 p-6 lg:p-10">
        ...
        <div className="flex flex-col justify-center text-center lg:text-left">
          <div className="inline-flex items-center gap-2 self-center lg:self-start mb-4 px-3 py-1.5 rounded-full border border-border/50 bg-background/70">
            ...
            <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground/70">Onboarding · 3 pasos</span>
          </div>

          <h1 className="text-[clamp(2rem,5vw,3.2rem)] font-black tracking-[-0.04em] leading-[0.95]">
            Empecemos a desbloquear tus ahorros.
          </h1>
          <p className="text-sm text-muted-foreground/70 mt-3 max-w-xl mx-auto lg:mx-0">
            Corre el Analizador, conecta tus datos y completa el perfil de marca. Tardarás unos minutos y obtendrás un informe claro y accionable.
          </p>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:justify-center lg:justify-start">
            <Link to="/Analyzer">
              <Button className="h-11 rounded-full px-6 text-sm font-bold bg-saas-gradient text-white shadow-lg ring-1 ring-white/10">
                Ejecutar Analizador <ArrowRight className="h-4 w-4" />
              </Button>
            </Link>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground/60">Progreso</span>
            </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {[{label:'Analizador', color:'text-cambra-lilac', bg:'bg-cambra-lilac-soft border-cambra-lilac'}, {label:'Datos', color:'text-cambra-mint', bg:'bg-cambra-mint-soft border-cambra-mint'}, {label:'Perfil', color:'text-cambra-plum', bg:'bg-cambra-plum-soft border-cambra-plum'}].map((t, i)=> (
              <motion.div
                key={t.label}
              ...
              >
                <p className="text-xs text-muted-foreground/50 mb-1">Paso {i+1}</p>
          ...
          <div className="mt-5 flex items-center gap-4 p-4 rounded-xl border border-border/50 bg-secondary/30">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold leading-none">Completa tu onboarding</p>
              <p className="text-[11px] text-muted-foreground/60 mt-1">Termina los 3 pasos para desbloquear el informe verificado.</p>
            </div>
          </div>
        </motion.div>
      </div>
