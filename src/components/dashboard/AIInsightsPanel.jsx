...
const STATUS_CONFIG = {
  running:            { label: "Running",            icon: Loader2,      cls: "text-blue-700 bg-blue-50 border-blue-200",     spin: true },
  awaiting_approval:  { label: "Awaiting approval",  icon: Clock,        cls: "text-amber-700 bg-amber-50 border-amber-200" },
  approved:           { label: "Approved",           icon: CheckCircle2, cls: "text-emerald-700 bg-emerald-50 border-emerald-200" },
  rejected:           { label: "Rejected",           icon: AlertCircle,  cls: "text-rose-700 bg-rose-50 border-rose-200" },
  completed:          { label: "Completed",          icon: CheckCircle2, cls: "text-emerald-700 bg-emerald-50 border-emerald-200" },
  failed:             { label: "Failed",             icon: AlertCircle,  cls: "text-rose-700 bg-rose-50 border-rose-200" },
};
    ...
    <div className="rounded-2xl border border-border/60 bg-card p-5">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground/60 font-semibold">AI Insights</p>
            <p className="text-sm font-bold tracking-tight">Latest agent runs</p>
          </div>
        </div>
      ...
      {loading && (
        <div className="py-6 flex items-center justify-center text-xs text-muted-foreground gap-2">
          <Loader2 size={12} className="animate-spin" /> Loading agent runs…
        </div>
      )}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    ...
                    <span className="text-[10px] text-muted-foreground/60 ml-auto">
                      {timeAgo(r.created_at || r.created_date)}
                    </span>
                  </div>
