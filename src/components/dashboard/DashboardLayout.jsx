...
export default function DashboardLayout() {
  ...
  return (
    <div
      className={`${isLightWorkspace ? "" : "dark"} min-h-screen flex w-full max-w-full overflow-x-hidden font-inter`}
      style={{
    ...
    >
      ...
      <main
        className="relative min-w-0 max-w-full flex-1 overflow-x-hidden pt-[72px] lg:pt-0"
