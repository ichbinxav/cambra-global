...
export default function RecoverEconomicsV2Card({activation,reports=[],invoices=[],rules=[]}){
 ...
 const today=new Date().toISOString().slice(0,10); const start=activation.recovery_term_start_date; const end=activation.recovery_term_end_date;
 const stage=!start?c.pending:today>=end?c.ended:c.active; const standard=!start||today>=end?0:25;
