...
const PROOF = [
  ...
  { value: "−52%", label: "on payments", icon: CreditCard, color: "text-brand", bg: "bg-blue-500/[0.08] border-blue-500/20" },
  { value: "−18%", label: "on shipping", icon: Truck, color: "text-deep", bg: "bg-green-500/[0.08] border-green-500/20" },
  { value: "−30%", label: "on SaaS tools", icon: Package, color: "text-brand", bg: "bg-orange-500/[0.08] border-orange-500/20" },
];
