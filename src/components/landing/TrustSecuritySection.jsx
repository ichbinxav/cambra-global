...
export default function TrustSecuritySection() {
  ...
  return (
    <section id="trust" className="relative scroll-mt-20 py-12 sm:py-16">
      <motion.div
      ...
      >
        ...
        <div className="relative z-10 mt-8 grid grid-cols-1 items-center gap-7 lg:grid-cols-[minmax(500px,1.08fr)_minmax(0,.92fr)] lg:gap-10">
          <motion.div
            initial={{ opacity: 0, scale: 0.97 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.72, ease: [0.22, 1, 0.36, 1] }}
            className="relative flex min-h-[300px] items-center justify-center sm:min-h-[390px]"
          >
            ...
            {BULLETS.map((b, index) => {
              ...
              return (
                <motion.article
                  ...
                  className="flex min-h-[142px] items-start gap-3 rounded-[20px] p-5"
