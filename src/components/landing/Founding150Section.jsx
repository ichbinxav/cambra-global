  ...
  return (
    <section className="relative py-12 sm:py-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        {/* lateral image */}
        <motion.div
          className="relative lg:col-span-5 flex justify-center items-center overflow-visible"
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-60px" }}
        ...
        >
          <img
            ...
            width={600}
            height={600}
            className="relative hero-stack w-full max-w-none h-auto select-none lg:absolute lg:right-full lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-[55%] lg:w-[115%]"
            draggable={false}
          />
        </motion.div>
      </div>
