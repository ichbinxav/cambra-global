        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-10 text-sm text-white/65 leading-relaxed">
            {[
              ...
              { title: "7. Recovery service — success fee", content: "If you opt in to the Recovery service, CAMBRA acts on your behalf to renegotiate your card-payment rates with your PSP (or migrate you to a better one where relevant). The fee is 25% of verified payment savings, calculated over a 24-month agreement from the moment savings become measurable on your real Stripe (or other PSP) statements. Key rules: (a) no upfront fee, no subscription, no minimum; (b) if no verified savings are recovered, you owe nothing; (c) 'verified savings' means the delta between your baseline effective rate and your new effective rate, evidenced by actual PSP statements reconciled by CAMBRA; (d) after the 24-month agreement, 100% of ongoing savings stay with you; (e) the specific terms of each recovery mandate are formalized in a separate written mandate signed before any negotiation is undertaken." },
              { title: "8. Provider compensation", content: "CAMBRA may receive compensation from service providers (revenue share) based on the aggregated volume it directs to them. This compensation never influences our recommendations: CAMBRA always recommends the option that saves the brand the most. Details of the provider program are described on our For Providers page (/ForProviders)." },
