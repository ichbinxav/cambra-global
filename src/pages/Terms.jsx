        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-10 text-sm text-white/65 leading-relaxed">
            {[
              ...
              { title: "7. Recovery service — success fee", content: "If you opt in to the Recovery service, CAMBRA acts on your behalf to negotiate lower rates and migrate providers where relevant. The fee is 25% of verified savings, calculated over a 24-month horizon from the moment savings become measurable on your real provider statements. Key rules: (a) no upfront fee, no subscription, no minimum; (b) if no verified savings are recovered, you owe nothing; (c) 'verified savings' means the delta between your baseline cost and your new cost, evidenced by actual provider statements reconciled by CAMBRA; (d) after the 24-month period, 100% of ongoing savings stay with you; (e) SaaS-stack savings are always kept 100% by you, with 0% fee; (f) the specific terms of each recovery mandate are formalized in a separate written mandate signed before any negotiation is undertaken." },
              { title: "8. Network directory", content: "The member directory is accessible only to authenticated, verified members. Listings are not endorsements. Brands are responsible for the accuracy of their own profile. Contact information visible in the directory may only be used for legitimate business collaboration between members — never for unsolicited prospecting, mass mailing or resale." },
              { title: "9. Acceptable use", content: "You agree not to: reverse-engineer the platform, scrape benchmark data, misrepresent your brand, upload unlawful content, attempt to access another user's data, or use CAMBRA to build a directly competing service. Violations may result in immediate suspension without refund." },
              { title: "10. Intellectual property", content: "The CAMBRA platform, brand, methodology, benchmarks and software are the exclusive property of CAMBRA GLOBAL SASU. No provision of these Terms transfers any intellectual property right to you, except the limited licence to use the service." },
              { title: "11. Limitation of liability", content: "To the maximum extent permitted by French law, CAMBRA is not liable for indirect, incidental, special or consequential damages arising from use of the platform. Total aggregate liability is capped at the greater of (a) the amounts paid by you to CAMBRA in the twelve months preceding the claim, or (b) €5,000. Nothing in these Terms limits liability for gross negligence, wilful misconduct or death/personal injury." },
              { title: "12. Withdrawal (B2B)", content: "The platform is a professional B2B service. The 14-day consumer withdrawal right under the French Consumer Code does not apply. You may nevertheless terminate your account at any time from Account settings under Section 13 below." },
              { title: "13. Termination", content: "You may terminate your account at any time from Account settings. Ongoing recovery mandates continue under their existing terms unless the mandate itself is revoked in writing. CAMBRA may suspend or terminate access for material violations of these terms or for prolonged inactivity (>24 months). Upon termination, your data is handled according to our Privacy Policy." },
              ...
              { title: "15. Contact", content: "For any contractual question: support@cambra.global. For legal notices: 42 rue Vivienne, 75002 Paris, France." },
            ].map((section, i) => (
