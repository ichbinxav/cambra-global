        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-10 text-sm text-white/65 leading-relaxed">
            {[
              ...
              { title: "8. Provider program", content: "CAMBRA operates a two-tier provider program described on our For Providers page (/ForProviders). Tier 1 (Listed) covers payment providers whose public pricing enters our achievable benchmark — no fee, no exclusivity, no compensation flows either way. Tier 2 (Partner) covers payment providers who offer an exclusive rate for merchants introduced through CAMBRA in exchange for a referral arrangement; when we present a Partner offer to a merchant it is labeled as a CAMBRA-exclusive offer, visually and semantically separate from our public benchmark. Our public benchmark is never influenced by Partner arrangements: CAMBRA always recommends the option that saves the brand the most, whether the winning anchor is Listed, Partner, or the merchant's existing provider. The specific commercial terms of each partnership are formalized in a signed agreement and disclosed to any interested provider upon written request to support@cambra.global." },
