  ...
  return (
    <div className="relative min-h-screen bg-background font-inter overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -top-32 right-1/4 w-[36rem] h-[36rem] rounded-full blur-3xl bg-ambient-mint opacity-[0.16]" />
      </div>
      <div className="relative max-w-3xl mx-auto px-6 py-16">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="font-display text-[clamp(2.5rem,6vw,5rem)] font-black tracking-[-0.045em] leading-[0.88] mb-4">Terms & <span className="text-saas-gradient">Conditions.</span></h1>
