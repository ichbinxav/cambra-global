        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-10 text-sm text-white/65 leading-relaxed">
            {[
              ...
              { title: "10. International transfers", content: "Where data is transferred outside the EEA (e.g. for AI inference by OpenAI or Google), we rely on Standard Contractual Clauses approved by the European Commission (Decision 2021/914) and apply equivalent technical and organizational safeguards." },
