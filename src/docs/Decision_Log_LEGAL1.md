...
| `cambra_analyzer_draft` | **sessionStorage** | `registrationProfile.js` (set/read) · `PaymentsAnalyzer.jsx`, `LoginGate.jsx`, `ConnectTools.jsx` | Conservar el progreso y los datos de negocio durante el registro y la elección de fuente | Sesión de pestaña | Estrictamente necesaria |
| `cambra_registration_profile` | **sessionStorage** | `registrationProfile.js` (set/read/delete) · `LoginGate.jsx`, `ReferralAttributionCapture.jsx` | Aplicar nombre y negocio al perfil autenticado correcto después del registro alojado | Hasta aplicarse o cerrar la pestaña | Estrictamente necesaria |
