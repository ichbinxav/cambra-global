...
| eclLifecycleScheduler | **scheduler-ready; cada invocación registra best-effort AgentTask `ecl_lifecycle_scheduler`; cron recurrente de plataforma sigue siendo configuración externa no representada por este repo** | gate (admin o interno) | StatementImport, SavingsEvidence, EvidenceLifecycleEvent, ReviewCase, AgentTask |
