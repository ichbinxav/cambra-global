...
| 14 | et (estonio) | — | EE → NATIVE | ✅ verify verde |
| 15–20 | lv, lt, sk, sl, nb, is | — | LV LT SK SI NO IS | ⏳ pendientes |

Mercados en NATIVE_PRODUCT tras el bloque 14: **FR ES GB AT DE LI IT CH PL
PT GR CY SE DK FI CZ RO HU BG HR EE (21 de 30 activos)**.
...
- `p9EuropeanLocalization.test.js`: la lista de product locales se amplía
  ...
  mercado testigo al siguiente pendiente (actual: LV).
