...
| HR | Croatia | EUR | hr-HR | NATIVE_PRODUCT | LIMITED | REVIEW_REQUIRED | LEGAL_REVIEW_REQUIRED |
...
| LT | Lithuania | EUR | lt-LT | NATIVE_PRODUCT | LIMITED | REVIEW_REQUIRED | LEGAL_REVIEW_REQUIRED |
...
| SK | Slovakia | EUR | sk-SK | NATIVE_PRODUCT | LIMITED | REVIEW_REQUIRED | LEGAL_REVIEW_REQUIRED |
| SI | Slovenia | EUR | sl-SI | NATIVE_PRODUCT | LIMITED | REVIEW_REQUIRED | LEGAL_REVIEW_REQUIRED |
...
| lt-LT | lt | IMPLEMENTED | AUTOMATED_QA | LEGAL_REVIEW_REQUIRED |
