...
const MANIFEST = [
  ...
  "outlookInboundRouter", "outlookMeetingCoordinator", "providerNegotiationAgent", "resendInboundWebhook", "resolveCommercialApproval", "reviewProviderContract", "startProviderNegotiation",
