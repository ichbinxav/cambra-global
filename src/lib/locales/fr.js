...
export default {
    ...
    su_badge_beta:      "Lecture IA",
    su_body_beta:       "Déposez un relevé {provider} (PDF ou CSV). Deux passes d'IA lisent les frais et les recoupent, puis nous transformons votre estimation en chiffre vérifié. Cela prend un instant, ce n'est pas immédiat.",
