...
export default {
    ...
    prob_total_label:      "Fuite annuelle totale",
    prob_total_line1:      "−7 400 €/an",
    prob_total_line2:      "≈ 15 000 € sur 24 mois",
    prob_total_line3:      " — le même argent que la courbe d'économies montre comme récupérable.",
    prob_total_note:       "Illustratif — un commerce avec 1 M€ de ventes annuelles, payant 2,21 % quand 1,47 % était possible. Lancez l'analyseur pour votre chiffre réel.",
    prob_total_per:        "/an · par commerce",
};