...
export default {
    ...
    su_badge_beta:      "AI reading",
    su_body_beta:       "Drop a {provider} statement (PDF or CSV). Two AI passes read the fees and cross-check them, then we turn your estimate into a verified number. It takes a moment, not instantly.",
