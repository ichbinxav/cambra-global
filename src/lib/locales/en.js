...
export default {
    ...
    prob_total_label:      "Total annual bleed",
    prob_total_line1:      "−€7,400/year",
    prob_total_line2:      "≈ €15,000 over 24 months",
    prob_total_line3:      " — the same money the Savings Curve shows as recoverable.",
    prob_total_note:       "Illustrative — a business with €1M in yearly sales, paying 2.21% when 1.47% was possible. Run the analyzer for your real number.",
    prob_total_per:        "/year · per business",
};