...
export default {
    ...
    /* landing — hero */
    hero_badge:           "PAYMENT INTELLIGENCE FOR BUSINESSES",
    hero_h1_line1:        "Know what accepting payments",
    ...
    hero_image_alt:       "Example CAMBRA analysis showing annual payment costs, effective rate and estimated opportunity across online and in-store payments.",
    ...
    legal_accept_eyebrow: "Before you continue",
    legal_accept_title: "Accept our terms to use CAMBRA",
    legal_accept_body: "CAMBRA processes payment data on your behalf. To continue we need your acceptance of the Terms & Conditions and of the Data Processing Agreement, which governs how we handle that data as your processor.",
    legal_accept_checkbox: "I have read and accept the Terms & Conditions and the Data Processing Agreement.",
    legal_accept_versions: "You are accepting Terms version {terms} and Data Processing Agreement version {dpa}. We record your acceptance with its date.",
    legal_accept_cta: "Accept and continue",
    legal_accept_saving: "Saving…",
    legal_accept_error: "We could not record your acceptance. Nothing has been accepted — please try again, and contact support@cambra.global if it persists.",
    ...
    /* dashboard */
    dash_home_eyebrow:    "YOUR PAYMENT WORKSPACE",
    dash_home_title:      "Good to see you, {name}.",
    dash_home_sub:        "See what CAMBRA knows, what needs your attention and the clearest next step.",
    dash_journey_title:   "Your path to lower payment costs",
    dash_journey_sub:     "Three clear steps. You stay in control at every one.",
    dash_verify_no_estimate: "Connect your provider or upload a statement to turn this first estimate into a reliable baseline.",
    ...
    changes_detected_n:   "{n} changes detected",
    never_label:          "never",
    ...
    prc_faq_a2_v2: "Where the legally approved terms are available in your market, CAMBRA's fee is 25% of positive verified savings throughout months 1–24. After month 24 it is 0%. No positive verified savings means no fee. Successful referrals reduce the applicable fee by 5 points each, with a 5% floor.",
    ...
    trust_sec_b1_t:    "Read-only connections",
    trust_sec_b1_d:    "CAMBRA only requests the restricted data access required for the analysis.",
    trust_sec_b2_t:    "No payment control",
    trust_sec_b2_d:    "CAMBRA cannot charge customers, initiate payments, transfer funds or change providers.",
    trust_sec_b3_t:    "Traceable results",
    trust_sec_b3_d:    "Important findings stay linked to the information and assumptions behind them.",
    trust_sec_b4_t:    "You stay in control",
    trust_sec_b4_d:    "Nothing changes unless your business reviews and approves it.",
    ...
    trust_sec_vault_alt: "Payment providers connected to CAMBRA through restricted, read-only data connections",
    ...
    pd_sub_v2:       "Analyze for free. Where the approved terms are available, Recover costs 25% of positive verified savings throughout months 1–24 and 0% afterwards.",
    pd_step1:        "Step 1",
    pd_step2:        "Step 2",
    ...
    /* Master visual refresh — referral attribution and account preferences. */
    login_gate_eyebrow: "Secure access",
    ref_code_label: "Referral code (optional)",
    ref_code_placeholder: "Enter your code",
    ref_code_help: "Have a referral code? Enter it before continuing.",
    ref_code_invalid: "This referral code is invalid or no longer active.",
    ref_code_applied: "Referral applied",
    ref_code_applied_body: "Your invited 20% success fee is now linked to this account.",
    ref_code_rejected: "Code not applied",
    ref_code_rejected_body: "This code is invalid, expired or already linked to another account.",
    ref_code_verified: "Referral verified",
    ref_code_account_lock: "Your invited rate stays linked to this account.",
    ref_registered_label: "Registered businesses",
    account_required_field: "This field is required.",
    account_required_note: "Fields marked * are required.",
    account_verified: "Verified",
    account_security_title: "Security & connections",
    account_manage_data: "Manage payment data",
    account_monthly_summary: "Monthly savings summary",
    account_active: "Active",
    account_monthly_body: "Receive a clear monthly recap of your identified opportunities at",
    account_monthly_enabled: "Monthly summary enabled",
    account_monthly_disabled: "Monthly summary disabled",
    account_preference_error: "We couldn't save this preference.",
    account_test_email: "Send a test email",
    account_sending: "Sending…",
    account_test_sent: "Test email sent. Check your inbox.",
    account_test_no_data: "Run an analysis first to generate a summary.",
    account_test_error: "We couldn't send the test email.",
    account_test_hint: "Sent to the verified email address above.",
};
