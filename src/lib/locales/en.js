...
export default {
    ...
    hero_h1_line1:        "See the infrastructure",
    hero_h1_line2:        "behind every payment.",
    hero_sub:             "CAMBRA turns payment costs, provider terms and market context into evidence-aware intelligence for independent European businesses. Start with payments; act only when the data supports it.",
    hero_cta_primary:     "Analyze my payments",
    hero_cta_secondary:   "See how CAMBRA works",
    hero_trust_1:         "Free initial analysis",
    hero_trust_2:         "Evidence state on every result",
    hero_trust_3:         "Market-aware across Europe",
    ...
    how_h2_pre:           "Four steps from operating context to",
    how_h2_hl:            "a governed decision",
    how_step1_title:      "Set your operating context",
    how_step1_desc:       "Tell us your market, payment channels, volume and provider. Market and language remain separate, explicit choices.",
    how_step2_title:      "Build the effective-cost view",
    how_step2_desc:       "CAMBRA calculates what your supplied figures imply and identifies which source assumptions are being used.",
    how_step3_title:      "Strengthen the evidence",
    how_step3_desc:       "Where available, read-only provider data or source documents can replace estimates with measured inputs.",
    how_step4_title:      "Choose a permitted next step",
    how_step4_desc:       "A recommendation, review or recovery path appears only when the market, evidence and authority gates allow it.",
    how_step_label:       "Step",
