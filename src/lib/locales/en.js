...
export default {
    ...
    prob_c1_body:          "A single all-in rate hides the minimum. Most businesses pay 2.0–2.6% when their real floor is 1.4–1.5%.",
    ...
    prob_total_line1:      "€24,000/year identified",
    prob_total_line2:      "€36,000 stays with the business over 24 months",
    prob_total_line3:      " — CAMBRA only earns 25% of what it actually recovers.",
    prob_total_note:       "Illustrative — a business paying €40,000/year in card fees at 2.00% when 0.80% was achievable. Run the analyzer for your real number.",
