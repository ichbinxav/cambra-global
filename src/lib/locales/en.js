...
export default {
    ...
    /* landing — hero */
    hero_badge:           "Payment cost audit for European businesses",
    hero_h1_line1:        "Find out what your payments",
    hero_h1_line2:        "really cost.",
    hero_sub:             "CAMBRA analyses your card fees, shows where you may be overpaying and helps you recover verified savings. The first analysis is free. You only pay when real savings are confirmed.",
    hero_cta_primary:     "Check my payment costs",
    hero_cta_secondary:   "How it works",
    hero_trust_1:         "Free first analysis",
    hero_trust_2:         "Clear evidence for every figure",
    hero_trust_3:         "Built for European markets",
    hero_image_alt:       "CAMBRA payment infrastructure intelligence interface",
    hero_visual_title:    "Infrastructure evidence map",
    hero_visual_status:   "Context ready",
    hero_visual_market:   "Market intelligence",
    hero_visual_market_sub: "Currency · language · policy",
    hero_visual_provider: "Provider intelligence",
    hero_visual_provider_sub: "Presence · product · eligibility",
    hero_visual_rate:     "Rate intelligence",
    hero_visual_rate_sub: "Source · freshness · cohort",
    hero_visual_opportunity: "Opportunity intelligence",
    hero_visual_opportunity_sub: "Range · confidence · next step",
    hero_visual_footer:   "No conclusion without evidence. No action without authority.",

    /* landing — how it works (steps) */
    how_h2:               "Four steps from estimate to recovered margin.",
    how_h2_pre:           "From payment fees to",
    how_h2_hl:            "a clear next step",
    how_step1_title:      "Tell us how you take payments",
    how_step1_desc:       "Choose your market, sales channels, volume and payment provider.",
    how_step2_title:      "See what your payments cost",
    how_step2_desc:       "CAMBRA estimates your effective rate and explains every assumption behind the result.",
    how_step3_title:      "Verify the figures",
    how_step3_desc:       "Connect read-only provider data or upload source documents to replace estimates with measured costs.",
    how_step4_title:      "Recover verified savings",
    how_step4_desc:       "When the evidence supports it, CAMBRA shows the safest route to renegotiate or switch provider.",
    how_step_label:       "Step",
    ...
    /* footer */
    footer_tagline:       "European infrastructure intelligence for independent commerce.",
    ...
    hiw_hero_h1:      "See your payment costs. Then decide what to do.",
    hiw_hero_sub:     "CAMBRA checks what you pay, verifies the opportunity and helps you recover savings without an upfront fee or lock-in.",
    ...
    prc_faq_a2: "When CAMBRA executes a Recover, the fee is 25% of positive verified savings in months 1–12 and 15% in months 13–24. After month 24 it is 0%. No verified savings means no fee. Successful referrals reduce the applicable fee by 5 points each, with a 5% floor during the Recovery Term.",
    ...
    ri_eyebrow:   "INTELLIGENCE SYSTEM",
    ri_h2_pre:    "From raw cost data to",
    ri_h2_kw:     "a decision you can defend.",
    ri_sub_pre:   "CAMBRA keeps market facts, provider facts, rate observations and opportunity hypotheses separate. The confidence label changes as the evidence improves.",
    ri_sub_kw:    "Evidence before action.",
    ri_sub_post:  "",
    ri_state_estimated: "Estimated",
    ri_state_provisional: "Provisional",
    ri_state_verified: "Verified",
    ri_layer_market_t: "Market intelligence",
    ri_layer_market_d: "Currency, geography, language coverage and action gates from the canonical market registry.",
    ri_layer_provider_t: "Provider intelligence",
    ri_layer_provider_d: "Product presence and eligibility are not treated as the same fact.",
    ri_layer_rate_t: "Rate intelligence",
    ri_layer_rate_d: "Sources, dates and comparison cohorts stay attached to every observation.",
    ri_layer_opportunity_t: "Opportunity intelligence",
    ri_layer_opportunity_d: "Potential value is presented as a range or withheld when support is insufficient.",
    ...
    /* Landing — final CTA */
    cta_final_eyebrow:     "Start with evidence",
    cta_final_h2_pre:      "Understand the cost.",
    cta_final_h2_kw:       "Then decide.",
    cta_final_sub1:        "Build a market-aware view of your payment infrastructure.",
    cta_final_sub2:        "No invented benchmark. No automatic action without authority.",
    cta_final_primary:     "Run free analysis",
    cta_final_secondary:   "Request a review",
    cta_final_t1:          "Market context",
    cta_final_t2:          "Source-linked",
    cta_final_t3:          "Authority-gated",
    cta_final_t4:          "Evidence before action",

    /* Landing — ProblemSectionWow (hidden cost problem) */
    prob_eyebrow:          "THE VISIBILITY PROBLEM",
    prob_h2_pre:           "A blended payment rate is",
    prob_h2_kw:            "not an explanation.",
    prob_h2_post:          "CAMBRA shows what supports the conclusion.",
    prob_intro:            "The aim is not to promise a universal saving. It is to separate measured cost, comparable evidence and the decisions that are actually permitted in your market.",
    prob_c1_cat:           "Source the cost",
    prob_c1_body:          "Start with merchant-supplied figures and, where available, replace assumptions with read-only data or source documents.",
    prob_c1_status:        "Source linked",
    prob_c2_cat:           "Build a fair comparison",
    prob_c2_body:          "Compare only against observations that match the relevant market, channel, provider product and merchant context.",
    prob_c2_status:        "Context matched",
    prob_c3_cat:           "Expose uncertainty",
    prob_c3_body:          "Every output remains estimated, provisional or verified. If evidence is insufficient, CAMBRA withholds the conclusion.",
    prob_c3_status:        "Confidence shown",
    prob_card_illustrative:"Illustrative · this angle",
    prob_card_overpay:     "Overpay vs network",
    prob_total_label:      "TRUTH RULE",
    prob_total_line1:      "No public example is presented as your outcome.",
    prob_total_line2:      "Evidence state remains visible",
    prob_total_line3:      " — unsupported conclusions are withheld.",
    prob_total_note:       "Your result is calculated from your inputs and the evidence available for the selected market. Missing evidence produces a limitation, not a fabricated number.",
    prob_total_per:        "evidence-aware",

    /* Landing + Pricing — PricingDual (two-step pricing cards) */
    pd_eyebrow:      "Pricing",
    pd_h2_pre:       "Start with analysis.",
    pd_h2_kw:        "Act with evidence.",
    pd_sub:          "Analyze for free. Recover is success-only: 25% of verified savings in months 1–12, 15% in months 13–24, then 0%.",
    pd_step1:        "Step 1",
    pd_step2:        "Step 2",
    ...
    az_title: "What are you overpaying on payments?",
    az_sub: "A few quick answers. No account required, no data connected. We estimate the gap between what you pay today and what a merchant of your size + region should be paying.",
    ...
    az_privacy_note: "No account, no data connected, nothing shared. Results are stored with an anonymous session id you can revisit from this device.",
    az_cta: "See my payments gap",
