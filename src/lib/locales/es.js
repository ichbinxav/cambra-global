...
export default {
    ...
    su_badge_beta:      "Lectura IA",
    su_body_beta:       "Sube un extracto de {provider} (PDF o CSV). Dos pasadas de IA leen las comisiones y las contrastan, y con eso convertimos tu estimación en un número verificado. Tarda un momento, no es instantáneo.",
