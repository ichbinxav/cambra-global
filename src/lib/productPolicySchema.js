...
export const productPolicySchema = z
  .object({
    ...
    economicTerms: z.object({
      ...
      successFeeRate: z.literal(0.25),
      merchantShareRate: z.literal(0.75),
      feeDurationMonths: z.literal(24),
      feeBase: z.literal("positive_verified_savings"),
      recoveryOptional: z.boolean(),
      recoveryEconomicsVersion: z.literal("recover-economics-v2"),
      postTermSuccessFeeRate: z.literal(0),
