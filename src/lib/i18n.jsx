...
const DICT = {
  en: {
    ...
    ins_layered_title:      "Your achievable rate, decomposed",
    ins_layered_sub:        "The floor you could reach, split into its three layers. Interchange and scheme fees are fixed — only the processor margin is negotiable, and that's exactly what we recover.",
    ins_layer_interchange:  "Interchange",
    ins_layer_interchange_note: "Regulated floor (EU IFR) — non-negotiable.",
    ins_layer_scheme:       "Scheme fees",
    ins_layer_scheme_note:   "Visa / Mastercard network fees — non-negotiable.",
    ins_layer_margin:       "Processor margin",
    ins_layer_margin_note:   "What your provider charges on top — CAMBRA recovers this.",
    ins_layer_negotiable:   "CAMBRA recovers this",
  ...
  fr: {
    ...
    ins_layered_title:      "Votre taux atteignable, décomposé",
    ins_layered_sub:        "Le plancher que vous pourriez atteindre, décomposé en trois couches. Interchange et frais de réseau sont fixes — seule la marge du processeur est négociable, et c'est exactement ce que nous récupérons.",
    ins_layer_interchange:  "Interchange",
    ins_layer_interchange_note: "Plancher réglementé (IFR UE) — non négociable.",
    ins_layer_scheme:       "Frais de réseau",
    ins_layer_scheme_note:   "Frais réseau Visa / Mastercard — non négociables.",
    ins_layer_margin:       "Marge du processeur",
    ins_layer_margin_note:   "Ce que votre prestataire facture en plus — CAMBRA le récupère.",
    ins_layer_negotiable:   "CAMBRA le récupère",
  ...
  es: {
    ...
    ins_layered_title:      "Tu tasa alcanzable, desglosada",
    ins_layered_sub:        "El suelo al que podrías llegar, desglosado en sus tres capas. Intercambio y tarifas de red son fijos — solo el margen del procesador es negociable, y eso es exactamente lo que recuperamos.",
    ins_layer_interchange:  "Intercambio",
    ins_layer_interchange_note: "Suelo regulado (IFR UE) — no negociable.",
    ins_layer_scheme:       "Tarifas de red",
    ins_layer_scheme_note:   "Tarifas de red Visa / Mastercard — no negociables.",
    ins_layer_margin:       "Margen del procesador",
    ins_layer_margin_note:   "Lo que tu proveedor cobra por encima — CAMBRA recupera esto.",
    ins_layer_negotiable:   "CAMBRA recupera esto",
