...
const dictionaries = { en, fr, es, de, it: itDict, pl, pt, el, sv, da, fi, cs, ro, hu, bg, hr, et, lv, lt, sk };
...
const SUPPORTED_LANGUAGES = ['en', 'fr', 'es', 'de', 'it', 'pl', 'pt', 'el', 'sv', 'da', 'fi', 'cs', 'ro', 'hu', 'bg', 'hr', 'et', 'lv', 'lt', 'sk'];
