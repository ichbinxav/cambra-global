...
async function claudeDraft(key:string, prospect:any, language:string){
 const prompt=[
  ...
  'Natural and founder-to-founder/professional tone. Concise, specific, no startup clichés, no hype, no generic opener, no em-dash-heavy prose, no bullet list. Max 90 words.',
