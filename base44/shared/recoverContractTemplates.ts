...
import { mandateCopy } from './recoverMandateCopy.ts';

// v2: FR/ES mandate body (actions + limits) and section titles now come from the
// shared copy module in the specified translated wording. A template bump means
// NEW mandates get the new document; historical ones are never rewritten.
export const RECOVER_CONTRACT_TEMPLATE_VERSION = 'recover-contract-pdf-v2';
...
// SINGLE SOURCE (RECOVER-3-FIX): the section titles, the authorized actions, the
// limits of authority and the acceptance checkbox live in
// shared/recoverMandateCopy.ts and are consumed here, by the popup (through
// getRecoverAcceptanceContext) and by the terms summary. This file keeps only the
// wording that is specific to the PDF (labels, field names, annex).
export { checkboxTextFor } from './recoverMandateCopy.ts';

const enCopy = mandateCopy('en');
...
const EN: ContractStrings = {
  ...
  s1_title: `1. ${enCopy.titles.purpose}`,
  s1_body: [
  ...
  s2_title: `2. ${enCopy.titles.baseline}`,
  s2_body: [
  ...
  s6_title: `6. ${enCopy.titles.actions}`,
  s6_body: [enCopy.actions_intro],
  s6_actions: enCopy.actions,
  s7_title: `7. ${enCopy.titles.limits}`,
  s7_body: enCopy.limits_body,
  s7_limits: enCopy.limits_bullets,
  s8_title: `8. ${enCopy.titles.payment_method}`,
  s8_body: [
  ...
  s9_title: `9. ${enCopy.titles.acceptance}`,
  s9_body: [
  ...
  s9_yes: 'Yes',
  s10_title: `10. ${enCopy.titles.documents}`,
  s10_body: [
  ...
  s11_title: `11. ${enCopy.titles.revocation}`,
  s11_body: [
...
const FR: ContractStrings = {
  ...
  s1_title: `1. ${frCopy.titles.purpose}`,
  s1_body: [
  ...
  s2_title: `2. ${frCopy.titles.baseline}`,
  s2_body: [
  ...
  s6_title: `6. ${frCopy.titles.actions}`,
  s6_body: [frCopy.actions_intro],
  s6_actions: frCopy.actions,
  s7_title: `7. ${frCopy.titles.limits}`,
  s7_body: frCopy.limits_body,
  s7_limits: frCopy.limits_bullets,
  s8_title: `8. ${frCopy.titles.payment_method}`,
  s8_body: [
  ...
  s9_title: `9. ${frCopy.titles.acceptance}`,
  s9_body: [
  ...
  s9_yes: 'Oui',
  s10_title: `10. ${frCopy.titles.documents}`,
  s10_body: [
  ...
  s11_title: `11. ${frCopy.titles.revocation}`,
  s11_body: [
...
const ES: ContractStrings = {
  ...
  s1_title: `1. ${esCopy.titles.purpose}`,
  s1_body: [
  ...
  s2_title: `2. ${esCopy.titles.baseline}`,
  s2_body: [
  ...
  s6_title: `6. ${esCopy.titles.actions}`,
  s6_body: [esCopy.actions_intro],
  s6_actions: esCopy.actions,
  s7_title: `7. ${esCopy.titles.limits}`,
  s7_body: esCopy.limits_body,
  s7_limits: esCopy.limits_bullets,
  s8_title: `8. ${esCopy.titles.payment_method}`,
  s8_body: [
  ...
  s9_title: `9. ${esCopy.titles.acceptance}`,
  s9_body: [
  ...
  s9_yes: 'Si',
  s10_title: `10. ${esCopy.titles.documents}`,
  s10_body: [
  ...
  s11_title: `11. ${esCopy.titles.revocation}`,
  s11_body: [
