// Moved from base44/functions/adminGlobalSearch/entry.ts (2026-08-18).
// Cross-function imports are not bundlable on the platform: adminSummaries was
// importing this handler from another function's directory, which made the
// whole adminSummaries deploy fail and left a stale build serving requests.
// The handler now lives in shared/ where every function can bundle it.
